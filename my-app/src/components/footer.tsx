        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 mb-8">
            <a
              ...
              className="flex items-center justify-center w-12 h-12 bg-blue-600 hover:bg-blue-700 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 hover:from-purple-700 hover:via-pink-700 hover:to-orange-600 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
            >
              <svg
