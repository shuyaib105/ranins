        ...
        <>
          ...
          <div className="mt-16 border-t border-gray-100 pt-10">
            ...
            <div className="flex flex-col gap-4">
              <Button
                className="w-full rounded-full bg-black py-8 text-sm font-black uppercase tracking-[1px] text-white shadow-2xl transition-all hover:scale-[1.03] hover:bg-gray-900 active:scale-95"
              ...
              <Button
                variant="outline"
                className="w-full rounded-full border-2 border-[#25D366] py-8 text-sm font-black uppercase tracking-[0.5px] text-[#25D366] transition-all hover:scale-[1.03] hover:bg-[#25D366]/5 active:scale-95"
